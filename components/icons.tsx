...
const Icons = {
  ...
  discord: (props: SVGProps<SVGSVGElement>) => (
    ...
    <svg
      ...
      {...props}
    >
      <title className="sr-only">Discord logo</title>
  ...
  email: (props: SVGProps<SVGSVGElement>) => (
    ...
    <svg
      ...
      {...props}
    >
      <title className="sr-only">Email icon</title>
  ...
  github: (props: SVGProps<SVGSVGElement>) => (
    ...
    <svg
      ...
      {...props}
    >
      <title className="sr-only">GitHub logo</title>
  ...
  maze: (props: SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <title className="sr-only">Maze logo</title>
