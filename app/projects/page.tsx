      ...
      <div className="flex flex-col gap-y-12 space-y-4">
        ...
        >
          <Paragraph>
            ...
            dashboard makes it easy for server admins to configure and control
            the bot.
          </Paragraph>
          <Paragraph>
            ...
            databases, implementing user authentication, and managing
        ...
        >
          <Paragraph>
            ...
            generates targeted unit tests to maximize code coverage.
          </Paragraph>
          <Paragraph>
