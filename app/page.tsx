...
export default function Home() {
  return (
    <Article title="Thijn Kroon">
      <Section>
        <Paragraph>
          Hi, I’m Thijn—a software engineer who enjoys working across the stack.
          I take pride in writing code that’s not just functional, but clean,
          organized, and well-structured. Outside of coding, I like to run,
          read, and occasionally lose track of time gaming.
        </Paragraph>
        <Paragraph>
